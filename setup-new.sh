...
sudo apt update && sudo DEBIAN_FRONTEND=noninteractive \
	...
	libxml-simple-perl libswitch-perl apt-utils libncurses5 libelf-dev cpio curl python-is-python3 byobu rclone llvm zsh lld  -y -qq
...
git config --global review.gerrit.libremobileos.com.username "ShelbyHell"
git config --global review.review.lineageos.org.username "ShelbyHell"
echo "export ARROW_GERRIT_USER=ShelbyHell" >> $sh_rc
